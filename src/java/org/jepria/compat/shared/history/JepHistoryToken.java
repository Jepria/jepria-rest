package org.jepria.compat.shared.history;

import static org.jepria.compat.shared.field.JepTypeEnum.BIGDECIMAL;
import static org.jepria.compat.shared.field.JepTypeEnum.BOOLEAN;
import static org.jepria.compat.shared.field.JepTypeEnum.DATE;
import static org.jepria.compat.shared.field.JepTypeEnum.DOUBLE;
import static org.jepria.compat.shared.field.JepTypeEnum.FLOAT;
import static org.jepria.compat.shared.field.JepTypeEnum.INTEGER;
import static org.jepria.compat.shared.field.JepTypeEnum.LIST_OF_OPTION;
import static org.jepria.compat.shared.field.JepTypeEnum.LIST_OF_PRIMITIVE;
import static org.jepria.compat.shared.field.JepTypeEnum.LIST_OF_RECORD;
import static org.jepria.compat.shared.field.JepTypeEnum.*;
import static org.jepria.compat.shared.field.JepTypeEnum.STRING;
import static org.jepria.compat.shared.field.JepTypeEnum.TIME;
import static org.jepria.compat.shared.history.JepHistoryConstant.LIST_VALUE_SEPARATOR;
import static org.jepria.compat.shared.history.JepHistoryConstant.LIST_VALUE_SEPARATOR_REGEXP;
import static org.jepria.compat.shared.history.JepHistoryConstant.MAP_NAME_TYPE_VALUE_SEPARATOR;
import static org.jepria.compat.shared.history.JepHistoryConstant.MAP_PROPERTY_SEPARATOR;
import static org.jepria.compat.shared.history.JepHistoryConstant.MAP_PROPERTY_SEPARATOR_REGEXP;
...
public class JepHistoryToken {
   ...
   *     (смотри {@link org.jepria.compat.shared.history.JepHistoryConstant});
   *   </li>
   *   <li>
   ...
   *   <li>{@link org.jepria.compat.shared.time.JepTime}</li>
   *   <li>{@link org.jepria.compat.shared.field.option.JepOption}</li>
   *   <li><code>java.util.List</code>&lt;{@link org.jepria.compat.shared.field.option.JepOption}&gt;</li>
   * </ul>
   * <br/>
   ...
   * <ul>
   *   <li>{@link JepTypeEnum#STRING}</li>
   *   <li>{@link JepTypeEnum#INTEGER}</li>
   *   <li>{@link JepTypeEnum#BOOLEAN}</li>
   *   <li>{@link JepTypeEnum#DATE}</li>
   *   <li>{@link JepTypeEnum#TIME}</li>
   *   <li>{@link JepTypeEnum#OPTION}</li>
   *   <li>{@link JepTypeEnum#LIST_OF_OPTION}</li>
   * </ul>
   * <br/>
