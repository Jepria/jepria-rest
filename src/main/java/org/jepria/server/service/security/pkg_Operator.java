...
import org.jepria.server.service.security.authorization.AuthorizationHelper;
...
public class pkg_Operator {
   ...
   */
  public static final Integer logon(Connection connection, String login, String password, String hash) throws SQLException {
    return AuthorizationHelper.getInstance(login, password, hash).logon(connection);
  }
   ...
   */
  public static final Integer logon(Connection connection, String login) throws SQLException {
    return AuthorizationHelper.getInstance(login, null, null).logon(connection);
  }
   ...
   * @throws SQLException
   */
  public static final boolean isChangePassword(Connection connection, Integer operatorId) throws SQLException {
   ...
   * @throws SQLException
   */
  public static final List<String> getRoles(Connection connection, String login) throws SQLException {
   ...
   * @throws SQLException
   */
  public static final List<String> getRoles(Connection connection, Integer operatorId) throws SQLException {
