...
public class PostGetSearchServiceImpl implements PostGetSearchService {
   ...
   */
  public PostGetSearchServiceImpl(Dao dao, RecordDefinition recordDefinition, Supplier<HttpSession> session) {
