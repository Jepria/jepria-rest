...
public interface DaoSupport {
   ...
   * @throws java.lang.RuntimeException в случае любого другого исключения
   */
  void deleteClob(String tableName, String dataFieldName, Map primaryKeyMap);
   ...
   * @throws java.lang.RuntimeException в случае любого другого исключения
   */
  void uploadClob(String tableName, String dataFieldName, Map primaryKeyMap, Reader reader);
   ...
   * @throws java.lang.RuntimeException в случае любого другого исключения
   */
  void deleteBlob(String tableName, String dataFieldName, Map primaryKeyMap);
   ...
   * @throws java.lang.RuntimeException в случае любого другого исключения
   */
  void uploadBlob(String tableName, String dataFieldName, Map primaryKeyMap, InputStream stream);
   ...
   * @throws java.lang.RuntimeException в случае любого другого исключения
   */
  default void uploadClob(String tableName, String dataFieldName, Map primaryKeyMap, String content) {
    if (content == null || "".equals(content)) {
      deleteClob(tableName, dataFieldName, primaryKeyMap);
    } else {
      uploadClob(tableName, dataFieldName, primaryKeyMap, new StringReader(content));
    }
  }
   ...
   * @throws java.lang.RuntimeException в случае любого другого исключения
   */
  default void uploadClob(String tableName, String dataFieldName, Map primaryKeyMap, InputStream stream, String charset) {
    final Reader reader;
    try {
    ...
    uploadClob(tableName, dataFieldName, primaryKeyMap, reader);
  }
  ...
  void downloadClob(String tableName, String dataFieldName, Map primaryKeyMap, Writer writer);
   ...
   * @throws java.lang.RuntimeException в случае любого другого исключения
   */
  void downloadBlob(String tableName, String dataFieldName, Map primaryKeyMap, OutputStream stream);
   ...
   */
  // no charset parameter because the database already knows which charset it uses to store clob
  default String downloadClob(String tableName, String dataFieldName, Map primaryKeyMap) {
    StringWriter stringWriter = new StringWriter();
    downloadClob(tableName, dataFieldName, primaryKeyMap, stringWriter);
