package org.jepria.compat.server.util;

import static org.jepria.compat.server.JepRiaServerConstant.DEFAULT_ENCODING;
import static org.jepria.compat.server.JepRiaServerConstant.HTTP_REQUEST_PARAMETER_LANG;
import static org.jepria.compat.server.JepRiaServerConstant.LOCALE_KEY;
import static org.jepria.compat.shared.JepRiaConstant.DEFAULT_DATE_FORMAT;
import static org.jepria.compat.shared.JepRiaConstant.HTTP_REQUEST_PARAMETER_LOCALE;
import static org.jepria.compat.shared.JepRiaConstant.LOCAL_LANG;
...
public class JepServerUtil {
   ...
   * Преобразует строки в даты и даты в строки формата {@link JepRiaConstant#DEFAULT_DATE_FORMAT}.
   */
