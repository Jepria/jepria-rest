package org.jepria.compat.shared.field;
 ...
 * {@link org.jepria.compat.shared.history.JepHistoryToken#valueToToken(Object value)}, {@link #toHistoryToken()} и методы восстановления
 * объектов из строкового представления (из так называемого History Token'а) 
 * {@link org.jepria.compat.shared.history.JepHistoryToken#tokenToValue(String token)},
...
public enum JepTypeEnum {
  ...
  /**
   * Тип поля, содержащий в качестве своего значения экземпляр класса 
   * {@link org.jepria.compat.shared.time.JepTime}.
   */
  ...
  /**
   * Тип поля, содержащий в качестве своего значения экземпляр класса 
   * {@link org.jepria.compat.shared.field.option.JepOption}.
   */
