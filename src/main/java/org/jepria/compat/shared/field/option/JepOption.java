package org.jepria.compat.shared.field.option;
...
import static org.jepria.compat.shared.history.JepHistoryConstant.OPTION_NAME_VALUE_SEPARATOR;
import static org.jepria.compat.shared.history.JepHistoryConstant.OPTION_NAME_VALUE_SEPARATOR_REGEXP;

import java.util.ArrayList;
import java.util.List;

import org.jepria.compat.shared.dto.JepDto;
import org.jepria.compat.shared.history.JepHistoryConstant;
...
public class JepOption extends JepDto {
  ...
  /**
   * Преобразует список объектов List&lt;{@link org.jepria.compat.shared.field.option.JepOption}&gt; в строковое представление
   * (в History Token).
   *
   * @param list исходный список объектов List&lt;{@link org.jepria.compat.shared.field.option.JepOption}&gt;
   * @return строковое представление списка объектов List&lt;{@link org.jepria.compat.shared.field.option.JepOption}&gt; (History Token)
   *
   * @see org.jepria.compat.shared.history.JepHistoryToken#valueToToken(Object value)
   */
