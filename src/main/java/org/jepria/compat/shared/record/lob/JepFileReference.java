...
public class JepFileReference<T> implements IsSerializable {
  ...
  /**
   * Получение значения имени файла из объекта типа {@link org.jepria.compat.shared.record.lob.JepFileReference}.<br/>
   * Если в качестве параметра передан null или переданный параметр не является наследником 
   * {@link org.jepria.compat.shared.record.lob.JepFileReference}, то возвращаемый результат будет null.<br/>
  ...
  /**
   * Получение значения расширения имени файла из объекта типа {@link org.jepria.compat.shared.record.lob.JepFileReference}.<br/>
   * Если в качестве параметра передан null или переданный параметр не является наследником 
   * {@link org.jepria.compat.shared.record.lob.JepFileReference}, то возвращаемый результат будет null.<br/>
   * Пример использования в прикладном модуле:
   * <pre>
  ...
  /**
   * Получение значения MIME-типа файла из объекта типа {@link org.jepria.compat.shared.record.lob.JepFileReference}.<br/>
   * Если в качестве параметра передан null или переданный параметр не является наследником 
   * {@link org.jepria.compat.shared.record.lob.JepFileReference}, то возвращаемый результат будет null.<br/>
   * Пример использования в прикладном модуле:
   * <pre>
