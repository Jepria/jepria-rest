...
public class JepHistoryConstant {
  ...
  /**
   * Разделитель между именем и значением элемента {@link org.jepria.compat.shared.field.option.JepOption} в строке History.<br/>
   * <br/>
   ...
   * {@link org.jepria.compat.shared.field.option.JepOption} в строке History.<br/>
   * <br/>
