package org.jepria.compat.shared.dto;
...
public class JepDto extends HashMap<String, Object> implements IsSerializable {
   ...
   * Обязательно должно присутствовать данное поле (во избежание проблем с сериализацией при установке его как значение бина ({@link org.jepria.compat.shared.dto.JepDto}))<br/>
